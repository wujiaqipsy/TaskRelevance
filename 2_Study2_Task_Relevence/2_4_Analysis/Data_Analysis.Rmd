...
df.rt.jasp <- df.rt_m %>%   
  ...
  mutate(
    condition = case_when(
                  condition == "TR_main" ~ "TR",
                  condition == "TIR_main" ~ "TIR",
                ),
    shapes = case_when(
      shapes == "自我" ~ "self",
      shapes == "朋友" ~ "friend",
  ...
  pivot_wider(names_from = c("condition", "shapes", "ismatch"), values_from = "RT_m")
...
df.acc.jasp <- df.acc %>%
  ...
  pivot_wider(names_from = c("condition", "shapes", "ismatch"), values_from = "ACC")
