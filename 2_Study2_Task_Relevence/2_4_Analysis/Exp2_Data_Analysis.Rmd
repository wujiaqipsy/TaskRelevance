...
df.fatigue <- df %>%
  dplyr::group_by(subj_idx, TaskRelevance) %>%
  ...
  dplyr::group_by(subj_idx, TaskRelevance, phrase) %>%
  dplyr::summarise(
...
p_rt_subj <- ggplot2::ggplot(df.norm, aes(x = rt, y = density, color = Identity)) +
  ggplot2::geom_line() +
  ggplot2::geom_point() +
  ggplot2::theme_minimal() +
  ggplot2::facet_wrap(~ subj_idx + TaskRelevance + ismatch, ncol = 4) +
  ggplot2::theme(
  ...
  ggplot2::labs(title = "Reaction time distribution of each subject", x = "Reaction time (ms)", y = "Density")
...
target_pars <- c(
  ...
  "b_Identitystranger",
  "b_ismatch",
  "b_Identityfriend:ismatch",
  "b_Identitystranger:ismatch"
  # "b_ismatch_num",
  # "b_Identityfriend:ismatch_num",
  # "b_Identitystranger:ismatch_num"
  )
...
df_tr_rt_pop <- var_both_tr_rt_model %>%
  ...
  dplyr::mutate(
    ...
    Friend_NonMatch = Intercept  + Identityfriend,
    Stranger_NonMatch = Intercept  + Identitystranger,
    Self_Match = Intercept + ismatch, 
    Friend_Match = Intercept + ismatch + Identityfriend + `Identityfriend:ismatch`,
    Stranger_Match = Intercept + ismatch + Identitystranger + `Identitystranger:ismatch`
    # Self_Match = Intercept + ismatch_num,             
    # Friend_Match = Intercept + ismatch_num + Identityfriend + `Identityfriend:ismatch_num`,
    # Stranger_Match = Intercept + ismatch_num + Identitystranger + `Identitystranger:ismatch_num`
    )%>%
...
## 匹配条件
med_tr_rt_Self_Match<- round(df_tr_rt_fixed$Median[df_tr_rt_fixed$Identity == 'Self' & df_tr_rt_fixed$ismatch == 'Match'], digits = 2)
ll_tr_rt_Self_Match<- round(df_tr_rt_fixed$CI_low[df_tr_rt_fixed$Identity == 'Self' & df_tr_rt_fixed$ismatch == 'Match'], digits = 2)
ul_tr_rt_Self_Match<- round(df_tr_rt_fixed$CI_high[df_tr_rt_fixed$Identity == 'Self' & df_tr_rt_fixed$ismatch == 'Match'], digits = 2)

med_tr_rt_Friend_Match<- round(df_tr_rt_fixed$Median[df_tr_rt_fixed$Identity == 'Friend' & df_tr_rt_fixed$ismatch == 'Match'], digits = 2)
ll_tr_rt_Friend_Match<- round(df_tr_rt_fixed$CI_low[df_tr_rt_fixed$Identity == 'Friend' & df_tr_rt_fixed$ismatch == 'Match'], digits = 2)
ul_tr_rt_Friend_Match<- round(df_tr_rt_fixed$CI_high[df_tr_rt_fixed$Identity == 'Friend' & df_tr_rt_fixed$ismatch == 'Match'], digits = 2)

med_tr_rt_Stranger_Match<- round(df_tr_rt_fixed$Median[df_tr_rt_fixed$Identity == 'Stranger' & df_tr_rt_fixed$ismatch == 'Match'], digits = 2)
ll_tr_rt_Stranger_Match<- round(df_tr_rt_fixed$CI_low[df_tr_rt_fixed$Identity == 'Stranger' & df_tr_rt_fixed$ismatch == 'Match'], digits = 2)
ul_tr_rt_Stranger_Match<- round(df_tr_rt_fixed$CI_high[df_tr_rt_fixed$Identity == 'Stranger' & df_tr_rt_fixed$ismatch == 'Match'], digits = 2)


## 不匹配条件
med_tr_rt_Self_NonMatch<- round(df_tr_rt_fixed$Median[df_tr_rt_fixed$Identity == 'Self' & df_tr_rt_fixed$ismatch == 'NonMatch'], digits = 2)
ll_tr_rt_Self_NonMatch<- round(df_tr_rt_fixed$CI_low[df_tr_rt_fixed$Identity == 'Self' & df_tr_rt_fixed$ismatch == 'NonMatch'], digits = 2)
ul_tr_rt_Self_NonMatch<- round(df_tr_rt_fixed$CI_high[df_tr_rt_fixed$Identity == 'Self' & df_tr_rt_fixed$ismatch == 'NonMatch'], digits = 2)

med_tr_rt_Friend_NonMatch<- round(df_tr_rt_fixed$Median[df_tr_rt_fixed$Identity == 'Friend' & df_tr_rt_fixed$ismatch == 'NonMatch'], digits = 2)
ll_tr_rt_Friend_NonMatch<- round(df_tr_rt_fixed$CI_low[df_tr_rt_fixed$Identity == 'Friend' & df_tr_rt_fixed$ismatch == 'NonMatch'], digits = 2)
ul_tr_rt_Friend_NonMatch<- round(df_tr_rt_fixed$CI_high[df_tr_rt_fixed$Identity == 'Friend' & df_tr_rt_fixed$ismatch == 'NonMatch'], digits = 2)

med_tr_rt_Stranger_NonMatch<- round(df_tr_rt_fixed$Median[df_tr_rt_fixed$Identity == 'Stranger' & df_tr_rt_fixed$ismatch == 'NonMatch'], digits = 2)
ll_tr_rt_Stranger_NonMatch<- round(df_tr_rt_fixed$CI_low[df_tr_rt_fixed$Identity == 'Stranger' & df_tr_rt_fixed$ismatch == 'NonMatch'], digits = 2)
ul_tr_rt_Stranger_NonMatch<- round(df_tr_rt_fixed$CI_high[df_tr_rt_fixed$Identity == 'Stranger' & df_tr_rt_fixed$ismatch == 'NonMatch'], digits = 2)
...
# ggsave(file.path(figDir, "Tr_RT.png"))
```
...
# ggsave(file.path(figDir, "Tr_RT_diff.png"))
...
df_tr_sdt_pop <- var_both_tr_sdt_model %>%
  ...
  dplyr::ungroup() %>%
  dplyr::mutate(term = gsub("b_", "", term),
                term = dplyr::case_when((term == "Identityself") ~ "c_Self",
                                              (term == "Identityfriend") ~ "c_Friend",
                                              (term == "Identitystranger") ~ "c_Stranger",
                                              (term == "Identityself:ismatch") ~ "dprime_Self",
                                              (term == "Identityfriend:ismatch") ~ "dprime_Friend",
                                              (term == "Identitystranger:ismatch") ~ "dprime_Stranger"),
...
med_tr_sdt_Self<- round(df_tr_sdt_fixed$Median[df_tr_sdt_fixed$Identity == 'Self' & df_tr_sdt_fixed$params == 'dprime'], digits = 2)
ll_tr_sdt_Self<- round(df_tr_sdt_fixed$CI_low[df_tr_sdt_fixed$Identity == 'Self' & df_tr_sdt_fixed$params == 'dprime'], digits = 2)
ul_tr_sdt_Self<- round(df_tr_sdt_fixed$CI_high[df_tr_sdt_fixed$Identity == 'Self' & df_tr_sdt_fixed$params == 'dprime'], digits = 2)

med_tr_sdt_Friend<- round(df_tr_sdt_fixed$Median[df_tr_sdt_fixed$Identity == 'Friend' & df_tr_sdt_fixed$params == 'dprime'], digits = 2)
ll_tr_sdt_Friend<- round(df_tr_sdt_fixed$CI_low[df_tr_sdt_fixed$Identity == 'Friend' & df_tr_sdt_fixed$params == 'dprime'], digits = 2)
ul_tr_sdt_Friend<- round(df_tr_sdt_fixed$CI_high[df_tr_sdt_fixed$Identity == 'Friend' & df_tr_sdt_fixed$params == 'dprime'], digits = 2)

med_tr_sdt_Stranger<- round(df_tr_sdt_fixed$Median[df_tr_sdt_fixed$Identity == 'Stranger' & df_tr_sdt_fixed$params == 'dprime'], digits = 2)
ll_tr_sdt_Stranger<- round(df_tr_sdt_fixed$CI_low[df_tr_sdt_fixed$Identity == 'Stranger' & df_tr_sdt_fixed$params == 'dprime'], digits = 2)
ul_tr_sdt_Stranger<- round(df_tr_sdt_fixed$CI_high[df_tr_sdt_fixed$Identity == 'Stranger' & df_tr_sdt_fixed$params == 'dprime'], digits = 2)
...
p_sdt_rt
# ggsave(file.path(figDir, "Tr_dprime.png"))
```
...
# ggsave(file.path(figDir, "Tr_dprime_diff.png"))
...
## 匹配条件
med_tir_rt_Self_Match<- round(df_tir_rt_fixed$Median[df_tir_rt_fixed$Identity == 'Self' & df_tir_rt_fixed$ismatch == 'Match'], digits = 2)
ll_tir_rt_Self_Match<- round(df_tir_rt_fixed$CI_low[df_tir_rt_fixed$Identity == 'Self' & df_tir_rt_fixed$ismatch == 'Match'], digits = 2)
ul_tir_rt_Self_Match<- round(df_tir_rt_fixed$CI_high[df_tir_rt_fixed$Identity == 'Self' & df_tir_rt_fixed$ismatch == 'Match'], digits = 2)

med_tir_rt_Friend_Match<- round(df_tir_rt_fixed$Median[df_tir_rt_fixed$Identity == 'Friend' & df_tir_rt_fixed$ismatch == 'Match'], digits = 2)
ll_tir_rt_Friend_Match<- round(df_tir_rt_fixed$CI_low[df_tir_rt_fixed$Identity == 'Friend' & df_tir_rt_fixed$ismatch == 'Match'], digits = 2)
ul_tir_rt_Friend_Match<- round(df_tir_rt_fixed$CI_high[df_tir_rt_fixed$Identity == 'Friend' & df_tir_rt_fixed$ismatch == 'Match'], digits = 2)

med_tir_rt_Stranger_Match<- round(df_tir_rt_fixed$Median[df_tir_rt_fixed$Identity == 'Stranger' & df_tir_rt_fixed$ismatch == 'Match'], digits = 2)
ll_tir_rt_Stranger_Match<- round(df_tir_rt_fixed$CI_low[df_tir_rt_fixed$Identity == 'Stranger' & df_tir_rt_fixed$ismatch == 'Match'], digits = 2)
ul_tir_rt_Stranger_Match<- round(df_tir_rt_fixed$CI_high[df_tir_rt_fixed$Identity == 'Stranger' & df_tir_rt_fixed$ismatch == 'Match'], digits = 2)


## 不匹配条件
med_tir_rt_Self_NonMatch<- round(df_tir_rt_fixed$Median[df_tir_rt_fixed$Identity == 'Self' & df_tir_rt_fixed$ismatch == 'NonMatch'], digits = 2)
ll_tir_rt_Self_NonMatch<- round(df_tir_rt_fixed$CI_low[df_tir_rt_fixed$Identity == 'Self' & df_tir_rt_fixed$ismatch == 'NonMatch'], digits = 2)
ul_tir_rt_Self_NonMatch<- round(df_tir_rt_fixed$CI_high[df_tir_rt_fixed$Identity == 'Self' & df_tir_rt_fixed$ismatch == 'NonMatch'], digits = 2)

med_tir_rt_Friend_NonMatch<- round(df_tir_rt_fixed$Median[df_tir_rt_fixed$Identity == 'Friend' & df_tir_rt_fixed$ismatch == 'NonMatch'], digits = 2)
ll_tir_rt_Friend_NonMatch<- round(df_tir_rt_fixed$CI_low[df_tir_rt_fixed$Identity == 'Friend' & df_tir_rt_fixed$ismatch == 'NonMatch'], digits = 2)
ul_tir_rt_Friend_NonMatch<- round(df_tir_rt_fixed$CI_high[df_tir_rt_fixed$Identity == 'Friend' & df_tir_rt_fixed$ismatch == 'NonMatch'], digits = 2)

med_tir_rt_Stranger_NonMatch<- round(df_tir_rt_fixed$Median[df_tir_rt_fixed$Identity == 'Stranger' & df_tir_rt_fixed$ismatch == 'NonMatch'], digits = 2)
ll_tir_rt_Stranger_NonMatch<- round(df_tir_rt_fixed$CI_low[df_tir_rt_fixed$Identity == 'Stranger' & df_tir_rt_fixed$ismatch == 'NonMatch'], digits = 2)
ul_tir_rt_Stranger_NonMatch<- round(df_tir_rt_fixed$CI_high[df_tir_rt_fixed$Identity == 'Stranger' & df_tir_rt_fixed$ismatch == 'NonMatch'], digits = 2)
...
# theme_apa()
p_tir_rt
# ggsave(file.path(figDir, "Tir_RT.png"))
```
...
# ggsave(file.path(figDir, "Tir_RT_diff.png"))
...
med_tir_sdt_Self<- round(df_tir_sdt_fixed$Median[df_tir_sdt_fixed$Identity == 'Self' & df_tir_sdt_fixed$params == 'dprime'], digits = 2)
ll_tir_sdt_Self<- round(df_tir_sdt_fixed$CI_low[df_tir_sdt_fixed$Identity == 'Self' & df_tir_sdt_fixed$params == 'dprime'], digits = 2)
ul_tir_sdt_Self<- round(df_tir_sdt_fixed$CI_high[df_tir_sdt_fixed$Identity == 'Self' & df_tir_sdt_fixed$params == 'dprime'], digits = 2)

med_tir_sdt_Friend<- round(df_tir_sdt_fixed$Median[df_tir_sdt_fixed$Identity == 'Friend' & df_tir_sdt_fixed$params == 'dprime'], digits = 2)
ll_tir_sdt_Friend<- round(df_tir_sdt_fixed$CI_low[df_tir_sdt_fixed$Identity == 'Friend' & df_tir_sdt_fixed$params == 'dprime'], digits = 2)
ul_tir_sdt_Friend<- round(df_tir_sdt_fixed$CI_high[df_tir_sdt_fixed$Identity == 'Friend' & df_tir_sdt_fixed$params == 'dprime'], digits = 2)

med_tir_sdt_Stranger<- round(df_tir_sdt_fixed$Median[df_tir_sdt_fixed$Identity == 'Stranger' & df_tir_sdt_fixed$params == 'dprime'], digits = 2)
ll_tir_sdt_Stranger<- round(df_tir_sdt_fixed$CI_low[df_tir_sdt_fixed$Identity == 'Stranger' & df_tir_sdt_fixed$params == 'dprime'], digits = 2)
ul_tir_sdt_Stranger<- round(df_tir_sdt_fixed$CI_high[df_tir_sdt_fixed$Identity == 'Stranger' & df_tir_sdt_fixed$params == 'dprime'], digits = 2)
...
p_sdt
# ggsave(file.path(figDir, "Tir_dprime.png"))
```
...
# ggsave(file.path(figDir, "Tir_dprime_diff.png"))
...
# 1. 给df_tr添加标识+取4-9列
df_tr_sub <- df_tr_rt_pop_diff_wide %>%
  dplyr::select(4:9) %>%  # 提取4-9列
  dplyr::mutate(TaskRelevance = "TR")  # 标注为TR

# 2. 给df_tir添加标识+取4-9列
df_tir_sub <- df_tir_rt_pop_diff_wide %>%
  dplyr::select(4:9) %>%  # 提取4-9列
  dplyr::mutate(TaskRelevance = "TIR")  # 标注为TIR

# 3. 合并两个子数据框
combined_df <- dplyr::bind_rows(df_tr_sub, df_tir_sub)

# 4. 计算匹配条件下差异的差异
df_diff_diff <- combined_df %>%
  tidyr::pivot_longer(
  ...
  dplyr::mutate(
    diff_dfff_SF = TR_diff_SF_Match - TIR_diff_SF_Match,
    diff_dfff_SStr = TR_diff_SStr_Match - TIR_diff_SStr_Match,
    diff_dfff_FStr = TR_diff_FStr_Match - TIR_diff_FStr_Match
  ) %>%
  dplyr::select(diff_dfff_SF, diff_dfff_SStr, diff_dfff_FStr)   
...
## 匹配条件
med_tir_rt_Self_Match<- round(median(df$diff_dfff_SF), digits = 2)
ll_tir_rt_Self_Match<- round(df_diff_diff$CI_low[df_diff_diff$Identity == 'Self' & df_diff_diff$ismatch == 'Match'], digits = 2)
ul_tir_rt_Self_Match<- round(df_diff_diff$CI_high[df_diff_diff$Identity == 'Self' & df_diff_diff$ismatch == 'Match'], digits = 2)

med_tir_rt_Friend_Match<- round(median(df$diff_dfff_SStr), digits = 2)
ll_tir_rt_Friend_Match<- round(df_diff_diff$CI_low[df_diff_diff$Identity == 'Friend' & df_diff_diff$ismatch == 'Match'], digits = 2)
ul_tir_rt_Friend_Match<- round(df_diff_diff$CI_high[df_diff_diff$Identity == 'Friend' & df_diff_diff$ismatch == 'Match'], digits = 2)

med_tir_rt_Stranger_Match<- round(median(df$diff_dfff_FStr), digits = 2)
ll_tir_rt_Stranger_Match<- round(df_diff_diff$CI_low[df_diff_diff$Identity == 'Stranger' & df_diff_diff$ismatch == 'Match'], digits = 2)
ul_tir_rt_Stranger_Match<- round(df_diff_diff$CI_high[df_diff_diff$Identity == 'Stranger' & df_diff_diff$ismatch == 'Match'], digits = 2)
```

```{r}
bayestestR::sexit(df_diff_diff)
```
